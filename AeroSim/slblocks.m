...
%   for the AeroSim Blockset.

%   Copyright 2003 Unmanned Dynamics, LLC
%   Revision: 1.1   Date: 08/02/2003

blkStruct.Name    = 'AeroSim Blockset';
blkStruct.OpenFcn = 'aerosimlib';
...
Browser(1).Library = 'aerosimlib';
Browser(1).Name    = 'AeroSim Blockset';
