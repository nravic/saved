...
#ifndef GLOBALDEFINES__VEHICLE_H
#define GLOBALDEFINES__VEHICLE_H
...
#ifndef ADD_ACCESSORS_AND_STORAGE
#define ADD_ACCESSORS_AND_STORAGE(tStorageType,tStorageName)\
	protected:\
	tStorageType m_##tStorageName;\
	public:\
	tStorageType& sGet##tStorageName(){return(m_##tStorageName);};\
	const tStorageType& sGet##tStorageName() const {return(m_##tStorageName);};
#endif
...
#endif	//#ifndef GLOBALDEFINES__VEHICLE_H
