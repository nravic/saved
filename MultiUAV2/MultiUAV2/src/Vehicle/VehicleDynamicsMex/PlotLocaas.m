function PlotLocaas(OutputMatrix,Time,IndexOut,cmdtype,Command)
...
AVDSOut = [Time,OutputMatrix(:,[IndexOut.stateX_Feet,IndexOut.stateY_Feet,IndexOut.stateZ_Feet]), ...
		...
		OutputMatrix(:,[IndexOut.outActuatorPosition0,IndexOut.outActuatorPosition1,IndexOut.outActuatorPosition2])*pi/180, ...
	];
...
% subplot(4,3,11);
% plot(Time(PlotRange),abs(OutputMatrix(PlotRange,IndexOut.outputDelta4Cmd)-OutputMatrix(PlotRange,IndexOut.outputDelta4)));
% grid;
...
% subplot(4,3,12);
% plot(Time(PlotRange),[OutputMatrix(PlotRange,[IndexOut.outputDelta4,IndexOut.outputDelta4Cmd])]);
% grid;
