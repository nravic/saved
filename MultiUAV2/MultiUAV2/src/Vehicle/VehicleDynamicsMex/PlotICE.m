function PlotICE(OutputMatrix,Time,IndexOut,cmdtype,Command)
...
title('Actuator4 and ActuatorCmd4 (deg)');
subplot(3,3,5);
plot(Time(PlotRange),[OutputMatrix(PlotRange,[IndexOut.outActuatorPosition4,IndexOut.outDeltaCmd_deg4])]);
grid;
title('Actuator5 and ActuatorCmd5 (deg)');
subplot(3,3,6);
plot(Time(PlotRange),[OutputMatrix(PlotRange,[IndexOut.outActuatorPosition5,IndexOut.outDeltaCmd_deg5])]);
grid;
title('Actuator6 and ActuatorCmd6 (deg)');
subplot(3,3,7);
plot(Time(PlotRange),[OutputMatrix(PlotRange,[IndexOut.outActuatorPosition6,IndexOut.outDeltaCmd_deg6])]);
grid;
title('Actuator7 and ActuatorCmd7 (deg)');
subplot(3,3,8);
plot(Time(PlotRange),[OutputMatrix(PlotRange,[IndexOut.outActuatorPosition7,IndexOut.outDeltaCmd_deg7])]);
grid;
title('Actuator8 and ActuatorCmd8 (deg)');
subplot(3,3,9);
plot(Time(PlotRange),[OutputMatrix(PlotRange,[IndexOut.outActuatorPosition8,IndexOut.outDeltaCmd_deg8])]);
grid;
title('Actuator9 and ActuatorCmd9 (deg)');
