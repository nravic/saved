function TestPlotWaypoints(action,WaypointArray,PathColor,FigureNumber,ImbeddedPlot,PlotTitle)
...
if(~exist('ImbeddedPlot')),
	ImbeddedPlot = 0;
end;
if(isempty(ImbeddedPlot)),
	ImbeddedPlot = 0;
end;
...
LabelString = sprintf('Trajectory%s',PlotTitle);
title(LabelString);
if (PrintToFiles == 1)
...
%NumberWaypoints = NumberWaypoints-2;	%don't plot the last waypoint
NumberWaypoints = NumberWaypoints-1;	%don't plot the last waypoint
