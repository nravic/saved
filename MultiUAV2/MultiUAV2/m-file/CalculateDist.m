function DistanceToGo = CalculateDist(VehicleID,CurrentPositionX,CurrentPositionY,CurrentWayCount,TurnRadius,ThisVehicleID)
...
WayPoints = g_VehicleMemory(ThisVehicleID).CooperationManager.WaypointMemory{VehicleID};
...
if CurrentWayCount == 1,
	InitialWayPoint = [CurrentPositionX,CurrentPositionY,g_DefaultWaypointAltitude,CurrentMachCmd,1,realmax,realmax,realmax,0,g_WaypointTypes.StartPoint,-1,0];
	CurrentWayCount = CurrentWayCount + 1;
	WayPoints = [InitialWayPoint;WayPoints];
end
